                                    ...
                                    <div class="single-pro-content">
                                        ...
                                        <div class="ec-single-qty">
                                            <div class="ec-single-cart ">
                                                <button class="btn btn-primary action-add-to-card" atr="Add to card">
                                                </button>
                                            </div>
                                        </div>
                                    </div>
...
@section('js')
    <script>
        // Mock dữ liệu để `public/customer/assets/js/page/product.js` render trực tiếp.
        // Mục tiêu: không gọi API thật cho trang product.
        (() => {
            const mockProduct = {
                id: 176,
                name: "Áo khoác nỉ ấm EKKA",
                description: "<p>Thiết kế form gọn, ấm áp và thoáng khí. Phù hợp mặc đi làm/đi chơi.</p>",
                detail: "<ul><li>Chất liệu: Nỉ mềm</li><li>Đường may chắc chắn</li><li>Phom đẹp, dễ phối đồ</li></ul>",
                prices: 599000,
                discount: 25, // %
                // Lưu ý: product.js sẽ render ảnh theo `src="/${value}"` nên `images` nên KHÔNG bắt đầu bằng `/`
                images: "customer/assets/images/product-image/1_1.jpg,customer/assets/images/product-image/1_2.jpg,customer/assets/images/product-image/1.jpg",
                metadata: JSON.stringify({
                    size: ["S", "M", "L", "XL"],
                    color: ["#111827", "#2563eb", "#f59e0b"]
                })
            };
            ...
            const mockRelated = [
                ...
                {
                    id: 179,
                    name: "Quần jean co giãn",
                    description: "",
                    detail: "",
                    prices: 529000,
                    discount: 30,
                    images: "customer/assets/images/product-image/4_1.jpg,customer/assets/images/product-image/4_2.jpg",
                    metadata: JSON.stringify({
                        size: ["28", "29", "30", "31"],
                        color: ["#1f2937", "#9ca3af"]
                    })
            ...
            // Override methods (chỉ trang này)
            Api.Product.GetOne = () => ok({ data: [mockProduct] });
            Api.Product.GetRelated = () => ok({ data: mockRelated });
        })();
    </script>
