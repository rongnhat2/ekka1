        ...
        <div class="container">
            <div class="row">
                ...
                <div class="ec-shop-leftside col-lg-3 order-lg-first col-md-12 order-md-last">
                    <div id="shop_sidebar" class="" style="">
                            ...
                            <div class="ec-sidebar-wrap">
                                <div class="ec-sidebar-block">
                                    <div class="ec-sb-title">
                                        <h3 class="ec-sidebar-title">Danh mục<div class="ec-sidebar-res"><i
                                        ...
                                        <ul class="category-list-filter">
                                            <li>
                                                <div class="ec-sidebar-block-item" category-id="0">
                                                    <input type="radio" name="category" category-id="0"> <a href="#">Tất cả
                                                        sản phẩm</a><span class="checked"></span>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="ec-sb-block-content es-price-slider">
                                        <div class="ec-price-filter">
                                            <div id="ec-sliderPrice" class="filter__slider-price" data-min="0"
                                                data-max="2000000" data-step="100000"></div>
                                        ...
                                        <button type="button"
                                            class="btn btn-primary w-100 m-t-20 filter-prices">Lọc</button>
                                    </div>
                                </div>
                            </div>
                        </div>
