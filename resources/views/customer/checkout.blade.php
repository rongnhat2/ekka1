                                        ...
                                        <div class="ec-check-bill-form">
                                            <form action="#" method="post">
                                                ...
                                                <span class="ec-bill-wrap">
                                                    ...
                                                    <input type="text" name="phone" id="telephone" value="" />
                                                </span>
                                                <!-- <div >
                                                                        <div>
...
@section('js')
    <script>
        // Mock data để `public/customer/assets/js/page/checkout.js` render mà không gọi API thật.
        (() => {
            const ok = (payload) => $.Deferred().resolve(payload).promise();

            // Seed giỏ hàng (checkout.js render dựa trên localStorage).
            localStorage.setItem("card", "901-902");
            localStorage.setItem("size", "M,L");
