                            ...
                            <div class="card-body">
                                ...
                                <template id="product-var-row-template">
                                    <div class="product-var-row d-flex align-items-end mb-2" style="gap:8px;">
                                        ...
                                        <div style="flex:.8;min-width:80px;">
                                            <label class="mb-1 font-weight-regular">Cảnh báo số lượng</label>
                                            <input type="number" min="0" class="form-control form-control-sm var-minQuantity"
                                                placeholder="Cảnh báo số lượng">
                                        </div>
