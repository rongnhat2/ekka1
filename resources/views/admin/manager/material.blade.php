                            ...
                            <div class="row m-b-10">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="align-justify-center">
                                        <a href="#" class="btn btn-default btn-sm flex-right modal-control"
                                            data-toggle="modal" atr="Create">Chất liệu<i class="fas fa-plus m-l-5"></i></a>
                                    </div>
                                </div>
                            </div>
...
@section('js')
    ...
    <script src="{{ asset('manager/assets/js/page/material.js') }}"></script>
