    ...
    modals: {
        ...
        Create: {
            ...
            getVal() {
                ...
                if (data_name == "") {
                    required_data.push("Hãy nhập tên kích thước.");
                    onPushData = false;
                }
            ...
            init() {
                ...
                var modalBodyHTML = Template.Material.Create();
        ...
        Update: {
            ...
            init() {
                ...
                var modalBodyHTML = Template.Material.Update();
        ...
        Delete: {
            ...
            init() {
                ...
                var modalBodyHTML = Template.Material.Delete();
