    ...
    modals: {
        ...
        Create: {
            ...
            getVal() {
                ...
                if (data_name == "") {
                    required_data.push("Hãy nhập tên thương hiện.");
                    onPushData = false;
                }
                if (data_description == "") {
                    required_data.push("Hãy nhập mô tả.");
                    onPushData = false;
                }
            ...
            init() {
                ...
                var modalBodyHTML = Template.Brand.Create();
        ...
        Update: {
            ...
            init() {
                ...
                var modalBodyHTML = Template.Brand.Update();
        ...
        Delete: {
            ...
            init() {
                ...
                var modalBodyHTML = Template.Brand.Delete();
